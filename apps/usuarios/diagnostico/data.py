...
PREGUNTAS_DIAGNOSTICO = [
    ...
    {
        "id": 5,
        "enunciado": ("¿Qué tipo de dato retorna la función len() en Python?"),
    ...
    },
    {
        "id": 6,
        "enunciado": (
            "En una lista [1, 2, 3, 4, 5], " "¿cuál es el índice del valor 3?"
        ),
        "opciones": ["1", "2", "3", "4"],
    ...
    {
        "id": 7,
        "enunciado": ("¿Cuál de estas estructuras almacena pares clave-valor?"),
    ...
    {
        "id": 8,
        "enunciado": ("Si f(x) = 2x² + 3x − 5, ¿cuánto es f(2)?"),
        "opciones": ["7", "8", "9", "10"],
